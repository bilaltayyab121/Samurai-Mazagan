                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 ${
                      hours.busiest ? 'bg-accent/20 text-accent' : 'bg-primary/10 text-primary'
                    }`}>
                      {hours.busiest ? <TrendingUp className="w-5 h-5" /> : <Clock className="w-5 h-5" />}
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className={`text-right ${
                      hours.closed ? 'text-red-400' : hours.busiest ? 'text-accent font-semibold' : 'text-white/80'
                    }`}>
          ...
          >
            ...
            >
              <div className="aspect-[4/3] w-full overflow-hidden">
                <img
                  src="https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=premium%20Japanese%20restaurant%20entrance%20elegant%20signage%20lanterns%20night%20time%20warm%20lighting&image_size=landscape_4_3"
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <h3 className="text-2xl font-playfair font-bold text-white mb-1">Find Us Easily</h3>
                <p className="text-white/70 text-sm">Located in the heart of El Jadida</p>
              </div>
            </motion.div>
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  ...
                  <div>
                    <div className="text-xs text-gray uppercase tracking-wider mb-1">{item.title}</div>
