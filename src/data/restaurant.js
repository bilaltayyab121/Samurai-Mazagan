export const restaurantData = {
  ...
  description: 'Experience the finest Japanese Hot Pot & Sushi in the heart of El Jadida. Our master chefs craft each dish with passion, using the freshest ingredients to bring you an unforgettable dining experience.',
  ...
  categories: ['Japanese Restaurant', 'Hot Pot Restaurant', 'Sushi Bar', 'Asian Dining'],
  address: {
